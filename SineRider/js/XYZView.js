...
function xyzMouseDown(xxx , yyy){//		called from mouseDown in SvgEditor.js
	...
	if(yyy < 45 && xxx > screenWidth-170 && xxx < screenWidth-30 && yyy > 5 ){//		clicked on the show/hide 3D view button drawn in XYZView.js
		show3D = !show3D;
...
function drawXYZ(){
	...
	//	xyz2.clearRect(0, 0, xyzWidth, xyzHeight);
		...
		//		if show3D is false, xyz canvas will be hidden since the UI is drawn to xyz2
		xyz2.clearRect(0, 0, xyzWidth, xyzHeight);
	}
